...
<head>
    ...
    <title>อัพเดตข้อมูลมอเตอร์ไซค์</title>
</head>

<body>
    <div class="container page-container">
        <h1 class="text-center">อัพเดตข้อมูลมอเตอร์ไซค์</h1>
            ...
            if ($conn->query($sql) === TRUE) {
                ...
                <div class="result-container">
                    ...
                    <div class="alert alert-success">
                        อัพเดตข้อมูลการจองเรียบร้อยแล้ว
                    </div>
                    <div class="mt-4">
                ...
                <div class="result-container">
                    ...
                    <div class="mt-4">
                        <a href="edit_1.php?action_even=edit&id_id=' . $id_id . '" class="btn btn-primary">กลับไปแก้ไขใหม่</a>
                    </div>
                </div>';
            }
        } else {
