...
<head>
    ...
    <style>
        ...
        h1 {
            color:rgb(255, 0, 255); /* Bright yellow */
            font-weight: 800;
            margin-bottom: 30px;
        ...
        .form-label {
            color:rgb(68, 255, 51); /* Bright red */
            font-weight: 500;
            text-align: left;
            display: block;
            margin-bottom: 8px;
        ...
        .btn-custom {
            width: 100%;
            margin-top: 15px;
            background-color:rgb(147, 236, 2); /* Dark red */
            border-color: #900000;
            transition: all 0.3s ease;
        }

        .btn-custom:hover {
            background-color:rgb(126, 236, 0); /* Bright red */
            border-color: #c10000;
        ...
        .footer {
            text-align: center;
            margin-top: 20px;
            color:rgb(51, 231, 255); /* Bright red */
            font-size: 0.9em;
        }
